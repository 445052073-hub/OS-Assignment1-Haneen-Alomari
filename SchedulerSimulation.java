...
private int priority;
    ...
    public Process(String name, int burstTime, int timeQuantum) {
        ...
        this.priority = 1 + new Random().nextInt(10);// Initially, remaining time is equal to the burst time
    }
...
public class SchedulerSimulation {
    ...
    public static void main(String[] args) {
        ...
        int studentID = 445052073;  // ← CHANGE THIS TO YOUR ACTUAL STUDENT ID
